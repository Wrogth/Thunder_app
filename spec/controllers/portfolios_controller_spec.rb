...
describe PortfoliosController do
  ...
  let(:valid_attributes) { { "feed" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # PortfoliosController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested portfolio as @portfolio" do
      portfolio = Portfolio.create! valid_attributes
      get :show, {:id => portfolio.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested portfolio as @portfolio" do
      portfolio = Portfolio.create! valid_attributes
      get :edit, {:id => portfolio.to_param}, valid_session
      assigns(:portfolio).should eq(portfolio)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Portfolio" do
        expect {
          post :create, {:portfolio => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved portfolio as @portfolio" do
        ...
        post :create, {:portfolio => { "feed" => "invalid value" }}, valid_session
        assigns(:portfolio).should be_a_new(Portfolio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested portfolio" do
        ...
        Portfolio.any_instance.should_receive(:update).with({ "feed" => "MyString" })
        put :update, {:id => portfolio.to_param, :portfolio => { "feed" => "MyString" }}, valid_session
      end

      it "assigns the requested portfolio as @portfolio" do
        portfolio = Portfolio.create! valid_attributes
        put :update, {:id => portfolio.to_param, :portfolio => valid_attributes}, valid_session
        assigns(:portfolio).should eq(portfolio)
      end
    ...
    describe "with invalid params" do
      it "assigns the portfolio as @portfolio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Portfolio.any_instance.stub(:save).and_return(false)
        put :update, {:id => portfolio.to_param, :portfolio => { "feed" => "invalid value" }}, valid_session
        assigns(:portfolio).should eq(portfolio)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested portfolio" do
      portfolio = Portfolio.create! valid_attributes
      expect {
        delete :destroy, {:id => portfolio.to_param}, valid_session
      }.to change(Portfolio, :count).by(-1)
    end
